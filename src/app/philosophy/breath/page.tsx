...
export const metadata = {
  title: "Meditation + Breathwork · 7point83 Club",
  description: "Guided meditation and breathwork rituals to reset your nervous system.",
};

export default function BreathPage() {
  const pillar = getPillarBySlug("breath") as PillarDetail;
  if (!pillar) {
    notFound();
  }
