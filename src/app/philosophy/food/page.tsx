...
export const metadata = {
  title: "Conscious Food · 7point83 Club",
  description: "Plant-forward, seasonal menus designed for mindful eating.",
};

export default function FoodPage() {
  const pillar = getPillarBySlug("food") as PillarDetail;
  if (!pillar) {
    notFound();
  }
